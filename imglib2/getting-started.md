...
Similar to the [ above example](getting-started#creating-and-displaying-an-image) we need an `ImgFactory` and an instance of the value type:
...
-   There are more [ImgLib2 Examples](examples) on [ Opening, creating and displaying images](examples#example-1---opening-creating-and-displaying-images).
